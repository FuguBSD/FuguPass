...
FuguPass is a password manager built on OpenBSD principles.
It derives all secrets from mnemonic phrases.
It stores keys offline as SeedQR codes.
No key material leaves the device, and no network service holds a secret.
