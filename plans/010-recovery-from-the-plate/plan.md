...
006 to plan 009 land every other subcommand of that rule, so PROG-ONESHOT then
reads `done`. REC-VAULT-4 names the re-enrollment of plan 009 as its second
step, and this plan lands the restore half.
