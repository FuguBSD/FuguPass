...
/*
 * The 2048 words of the BIP39 English list, copied from the list of
 * the BIP39 specification. A script made this table, so no person
 * edits it by hand. The words carry the digest WORDLIST_DIGEST, and
 * a test proves the table against that digest.
 *
 * FuguSeed pins the same digest for the same list, and it names that
...
static const char *const wordlist[WORDLIST_COUNT] = {
